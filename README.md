...
# Примеры эндпоинтов запрос/ответ

# Тесты
Описание тестов и покрытие?




При их добавлении кроме записи в таблицы `user_credential` и
    `customer` добавляется запись в базу данных `brt` - таблица `account` 
